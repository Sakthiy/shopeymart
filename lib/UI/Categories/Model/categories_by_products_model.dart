...
CategoriesByProductsModel categoriesByProductsModelFromJson(String str) =>
    CategoriesByProductsModel.fromJson(json.decode(str));

String categoriesByProductsModelToJson(CategoriesByProductsModel data) =>
...
class CategoriesByProductsModel {
  ...
  factory CategoriesByProductsModel.fromJson(Map<String, dynamic> json) =>
      CategoriesByProductsModel(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        fkBrand: json["fk_brand"] == null
            ? null
            : FkBrand.fromJson(json["fk_brand"]),
        ...
        productDescImages:
            List<dynamic>.from(json["product_desc_images"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "product_desc_images":
            List<dynamic>.from(productDescImages.map((x) => x)),
