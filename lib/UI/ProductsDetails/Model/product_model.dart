...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        fkSubcategory:  json["fk_subcategory"] == null ? null :FkSubcategory.fromJson(json["fk_subcategory"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "fk_subcategory": fkSubcategory!.toJson(),
...
class FkSubcategory {
  ...
  factory FkSubcategory.fromJson(Map<String, dynamic> json) => FkSubcategory(
        id: json["_id"],
