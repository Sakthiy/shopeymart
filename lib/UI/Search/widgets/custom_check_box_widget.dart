    ...
    return InkWell(
      ...
      child: Row(children: [
        Checkbox(
          ...
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppDouble.double8), side: BorderSide.none),
        ),
        Text(title, style: MyTextStyle.poppinsRegularTextStyleF13),
      ]),
    );
  }
}
