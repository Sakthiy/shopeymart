...
FavoriteProductsModel favoriteProductsModelFromJson(String str) => FavoriteProductsModel.fromJson(json.decode(str));

String favoriteProductsModelToJson(FavoriteProductsModel data) => json.encode(data.toJson());
...
class FavoriteProductsModel {
    ...
    factory FavoriteProductsModel.fromJson(Map<String, dynamic> json) => FavoriteProductsModel(
...
class Wishlist {
    ...
    factory Wishlist.fromJson(Map<String, dynamic> json) => Wishlist(
        ...
        productDescImages: List<ProductDescImage>.from(json["product_desc_images"].map((x) => ProductDescImage.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "product_desc_images": List<dynamic>.from(productDescImages.map((x) => x.toJson())),
...
class ProductDescImage {
    ...
    factory ProductDescImage.fromJson(Map<String, dynamic> json) => ProductDescImage(
