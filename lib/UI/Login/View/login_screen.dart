...
import '../../../CommonFiles/validator_email_phone_num.dart';
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MyTextFormField(
                        autovalidateMode: loginCtrl.isAutoValidator.value
                        ...
                        //     return AppStrings.invalidEmailId;
                        //   }
                        //   return null;
                        // },
                        validator: (input) => input == null
                            ? null
                            : ValidatorEmailPhoneNum.isEmail(input)
                                ? null
                                : "Enter valid email",
                          ...
                          : MyButton(
                              ...
                              onTap: () {
                                if (loginCtrl.formKey.currentState!
                                    .validate()) {
                                  loginCtrl.loginFunc(
                                    email: loginCtrl.emailCtrl.text.trim(),
                                    password:
                                        loginCtrl.passwordCtrl.text.trim(),
                                  );
                                } else {
                                  loginCtrl.isAutoValidator.value = true;
                                  loginCtrl.update();
                                }
                              },
                            ),
